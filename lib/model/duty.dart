...
class Duty {
  ...
  @override
  String toString() {
    return 'Duty(id: $id, startTime: $startTime, endTime: $endTime, dutyDate: $dutyDate, description: $description, transport: $transport, sptNumber: $sptNumber, sptLetterNumber: $sptLetterNumber, dateCreated: $dateCreated, createdAt: $createdAt, updatedAt: $updatedAt, status: ${status.makerDesc}, sapStatus: $sapStatus, sapError: $sapError)';
  }
  ...
  String get statusDescription => status.makerDesc;
}
